...
rb1 = Radiobutton( queryWindow, highlightbackground="red", text="1", value=1, variable=querySelect, command=changeFocus, takefocus=0 )
rb2 = Radiobutton( queryWindow, highlightbackground="red", text="2", value=2, variable=querySelect, command=changeFocus, takefocus=0 )
rb3 = Radiobutton( queryWindow, highlightbackground="red", text="3", value=3, variable=querySelect, command=changeFocus, takefocus=0 )
rb4 = Radiobutton( queryWindow, highlightbackground="red", text="4", value=4, variable=querySelect, command=changeFocus, takefocus=0 )
rb5 = Radiobutton( queryWindow, highlightbackground="red", text="5", value=5, variable=querySelect, command=changeFocus, takefocus=0 )
querySelect.set( 1 )
